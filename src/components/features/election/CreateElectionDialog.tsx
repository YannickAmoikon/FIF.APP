...
export default function CreateElectionDialog({onElectionCreated}: CreateElectionDialogProps) {
    ...
    const onSubmit = async (values: FormValues) => {
        try {
            ...
            const selectedType = types.find((type: TypeTypes) => type.id.toString() === values.type);
                                                ...
                                                <SelectGroup>
                                                    ...
                                                    {isLoading ? (
                                                        ...
                                                        types.map((type: TypeTypes) => (
                                                            ...
                                                            >
                                                                {type.name === "Private" ? "Privé" : type.name === "Public" ? "Public" : type.name === "Mixt" ? "Mixte" : type.name}
                                                            </SelectItem>
                                                        ))
                                                    )}
                                                </SelectGroup>
