...
export default function SideBar({ className = "" }: { className?: string }) {
  ...
  return (
    <>
      ...
      >
        <div className="h-[107px] flex items-center justify-between px-6 border-b-2 border-white/40 bg-orange-500">
          <div className="flex items-center space-x-4">
            <Image
              ...
              width={55}
              height={55}
              className="rounded-sm bg-white p-0.5 cursor-pointer shadow-md transform transition-transform hover:scale-105"
              priority
            />
